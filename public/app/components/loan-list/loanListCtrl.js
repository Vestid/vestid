angular.module('vestid').controller('loanListCtrl',
	...
	$scope.loans = [
		...
		{id: 3, type: 'IT Help', name: "iFix", loanAmount: 3400, favorited: true},
		...
		{id: 6, type: 'Customer Service', name: "PhoneMe", loanAmount: 1050, favorited: false},
		{id: 7, type: 'B2B', name: "Janiis", loanAmount: 5001, favorited: true},
